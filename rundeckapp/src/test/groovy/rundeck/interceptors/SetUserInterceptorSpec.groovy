...
class SetUserInterceptorSpec extends Specification implements InterceptorUnitTest<SetUserInterceptor>, DataTest {
    ...
    def "lookupToken"() {
        ...
        AuthToken userTk2 = new AuthToken(token: "456",user:u1,authRoles:"admin",type: AuthTokenType.USER, mode: AuthToken.Mode.LEGACY)
        AuthToken userTk3 = new AuthToken(token: "ABC",user:u1,authRoles:"admin",type: AuthTokenType.USER, mode: AuthToken.Mode.SECURED)
        AuthToken userTk4 = new AuthToken(token: "DEF",user:u1,authRoles:"admin",type: AuthTokenType.USER, mode: null)
        AuthToken whkTk = new AuthToken(token: "789",user:u2,authRoles:"admin",type:AuthTokenType.WEBHOOK, mode: AuthToken.Mode.LEGACY)
        u1.save()
        u2.save()
        userTk1.save()
        userTk2.save()
